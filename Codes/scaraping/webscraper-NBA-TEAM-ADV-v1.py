...
def create_team_stats_table(driver):
    ...
    data_row = [data_col]
    for year in lst:
        driver.get("https://stats.nba.com/teams/advanced/?sort=W&dir=-1&Season="+year+"&SeasonType=Regular%20Season")
        time.sleep(2)
    ...
    all_player_stats.to_csv("D:\\Northeastern courses\\DS 5110\\Project\\Data-Management-and-Processing-Project\\datasets\\team_stats_adv.csv",index=None, header=True)
...
if __name__ == "__main__":
    ...
    driver.get("https://stats.nba.com/teams/advanced/?sort=W&dir=-1&Season=2019-20&SeasonType=Regular%20Season&PlayerPosition=")
    time.sleep(.2)
