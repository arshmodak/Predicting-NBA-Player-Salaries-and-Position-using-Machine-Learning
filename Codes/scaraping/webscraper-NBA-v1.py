...
def create_team_stats_table(position,driver):
    ...
    data_row = [data_col]
    for year in lst:
        driver.get("https://stats.nba.com/players/traditional/?sort=PTS&dir=-1&Season="+year+"&SeasonType=Regular%20Season&PlayerPosition="+position)
        time.sleep(2)
    ...
    all_player_stats.to_csv(r"D:\Northeastern courses\DS 5110\Project\Data-Management-and-Processing-Project\datasets\player_stats_"+position+".csv",index=None, header=True)
...
def initialize_main_threads(position, driver):
    #print(driver)
    driver.get("https://stats.nba.com/players/advanced/?sort=GP&dir=-1&Season=2019-20&SeasonType=Regular%20Season&PlayerPosition="+ position)
    time.sleep(.2)
...
if __name__ == "__main__":
    ...
    chromeDriver = r"D:\Northeastern courses\DS 5110\Project\Data-Management-and-Processing-Project\scaraping\chromedriver.exe"
